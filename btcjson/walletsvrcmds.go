...
// GetBalanceTCmd defines the getbalanceT JSON-RPC command.
type GetBalanceTCmd struct {
	Account *string
	Token   *string
	MinConf *int `jsonrpcdefault:"1"`
}

// NewGetBalanceTCmd returns a new instance which can be used to issue a
// getbalanceT JSON-RPC command.
//
// The parameters which are pointers indicate they are optional.  Passing nil
// for optional parameters will use the default value.
func NewGetBalanceTCmd(account *string, token *string, minConf *int) *GetBalanceTCmd {
	return &GetBalanceTCmd{
		Account: account,
		Token:   token,
		MinConf: minConf,
	}
...
// NewListUnspentTCmd returns a new instance which can be used to issue a
// listunspentT JSON-RPC command.
//
// The parameters which are pointers indicate they are optional.  Passing nil
// for optional parameters will use the default value.
func NewListUnspentTCmd(tokenConf *string, minConf, maxConf *int, addresses *[]string) *ListUnspentTCmd {
	return &ListUnspentTCmd{
		Token:     tokenConf,
		MinConf:   minConf,
		MaxConf:   maxConf,
		Addresses: addresses,
...
func init() {
	...
	MustRegisterCmd("getbalanceT", (*GetBalanceTCmd)(nil), flags)
	...
	MustRegisterCmd("listunspentT", (*ListUnspentTCmd)(nil), flags)
